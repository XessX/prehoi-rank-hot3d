...
Status: formatted draft. Replace bracketed placeholders before submission.
...
subset increases data scale and class diversity but produces a harder, less
balanced split, so it is reported as supporting robustness evidence rather than
replacing the 50-clip primary controlled result.
